...
SOURCES = {
    ...
    # ──────────────────────────────────────────────────────────────
    # 第3批：Google News 聚合源 + 非洲综合媒体（2026-06-19）
    # ──────────────────────────────────────────────────────────────
    "google-solar-offgrid": {
        "name": "Google News · 非洲离网太阳能",
        "url": "https://news.google.com/rss/search?q=africa+solar+energy+off-grid&hl=en-US&gl=US&ceid=US:en",
        "type": "rss",
        "item_sel": "item",
        "title_sel": "title",
        "link_sel": "link",
    ...
    "google-solar-investment": {
        "name": "Google News · 非洲太阳能投资",
        "url": "https://news.google.com/rss/search?q=off-grid+solar+africa+investment+funding&hl=en-US&gl=US&ceid=US:en",
        "type": "rss",
        "item_sel": "item",
        "title_sel": "title",
        "link_sel": "link",
    ...
    "google-solar-policy": {
        "name": "Google News · 非洲太阳能政策",
        "url": "https://news.google.com/rss/search?q=africa+solar+policy+regulation+electrification&hl=en-US&gl=US&ceid=US:en",
        "type": "rss",
        "item_sel": "item",
        "title_sel": "title",
        "link_sel": "link",
    ...
    "google-clean-energy": {
        "name": "Google News · 非洲清洁能源",
        "url": "https://news.google.com/rss/search?q=africa+renewable+energy+solar+mini-grid&hl=en-US&gl=US&ceid=US:en",
        "type": "rss",
        "item_sel": "item",
        "title_sel": "title",
        "link_sel": "link",
